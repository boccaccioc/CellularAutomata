...
public class WaTorTest1 extends DukeTest {
  ...
  public void start(Stage stage) throws IOException {
    thisFileReader = new ReadCSVFile("Examples/WaTor/Test1.csv");
    thisGridData = new GridDataArray(thisFileReader.getGrid());
    test1GameofLifeController = new Controller();
    test1GameofLifeController.PROPERTIES_FILE = "WaTor/WaTor.properties";
  ...
  public void testFile() throws IOException {
    ...
    int[][] testArray = {{0,1,0},{0,2,0},{0,0,0}};
  ...
  public void testGridData() throws IOException {
    ...
    List<Integer> knownNeighbors = new ArrayList<Integer>(Arrays.asList(0,1,0,0,0,0,0,0));
  ...
  public void testGridModel() throws IOException {
    ...
    //GridModel thisGridModel = test1GameofLifeController;

    javafxRun(() -> {
      try {
        test1GameofLifeController.restartSimulationWithNewProp("WaTor/WaTor.properties");
      } catch (IOException e) {
        e.printStackTrace();
      }
    });
