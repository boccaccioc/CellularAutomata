...
public class SegregationTest1 extends DukeTest {
  ...
  public void start(Stage stage) throws IOException {
    thisFileReader = new ReadCSVFile("Examples/Segregation/Test1.csv");
    thisGridData = new GridDataArray(thisFileReader.getGrid());
    test1GameofLifeController = new Controller();
    test1GameofLifeController.PROPERTIES_FILE = "Shellings/SchellingsModelOfSegregation.properties";
  ...
  public void testFile() throws IOException {
    ...
    int[][] testArray = {{0,1,1},{1,2,1},{1,1,1}};
  ...
  public void testGridData() throws IOException {
    ...
    List<Integer> knownNeighbors = new ArrayList<Integer>(Arrays.asList(0,1,1,1,1,1,1,1));
  ...
  public void testGridView() throws IOException {
    ...
    assertEquals(agent1, thisGridView.getRectangle(0,1).getFill());
