...
public class SegregationTest3 extends DukeTest {
  ...
  public void start(Stage stage) throws IOException {
    thisFileReader = new ReadCSVFile("Examples/Segregation/Test3.csv");
    thisGridData = new GridDataArray(thisFileReader.getGrid());
    test1GameofLifeController = new Controller();
    test1GameofLifeController.PROPERTIES_FILE = "Shellings/SchellingsModelOfSegregatio3.properties";
  ...
  public void testFile() throws IOException {
    ...
    int[][] testArray = {{0,0,1},{1,2,1},{1,1,1}};
  ...
  public void testGridData() throws IOException {
    ...
    List<Integer> knownNeighbors = new ArrayList<Integer>(Arrays.asList(0,0,1,1,1,1,1,1));
    ...
    List<Integer> knownNeighbors2 = new ArrayList<Integer>(Arrays.asList(0,1,1,1));
  ...
  public void testGridModel() throws IOException {
    javafxRun(() -> {
      try {
        test1GameofLifeController.restartSimulationWithNewProp("Schellings/SchellingsModelOfSegregation3.properties");
      } catch (IOException e) {
        e.printStackTrace();
      }
    });
  ...
  public void testGridView() throws IOException {
    javafxRun(() -> {
      try {
        test1GameofLifeController.restartSimulationWithNewProp("Schellings/SchellingsModelOfSegregation.properties");
      } catch (IOException e) {
        e.printStackTrace();
      }
    });
    ...
    assertEquals(open, thisGridView.getRectangle(0,0).getFill());
    assertEquals(open, thisGridView.getRectangle(0,1).getFill());
    ...
    assertEquals(agent1, thisGridView.getRectangle(2,0).getFill());
    assertEquals(agent1, thisGridView.getRectangle(2,1).getFill());
    assertEquals(agent1, thisGridView.getRectangle(2,2).getFill());
    ...
    assertEquals(agent1, thisGridView.getRectangle(0,2).getFill());
    assertEquals(open, thisGridView.getRectangle(1,0).getFill());
    assertEquals(open, thisGridView.getRectangle(1,1).getFill());
    assertEquals(agent1, thisGridView.getRectangle(1,2).getFill());
    assertEquals(agent1, thisGridView.getRectangle(2,0).getFill());
    assertEquals(agent1, thisGridView.getRectangle(2,1).getFill());
    assertEquals(agent1, thisGridView.getRectangle(2,2).getFill());
    ...
    assertEquals(open, thisGridView.getRectangle(0,1).getFill());
    assertEquals(agent1, thisGridView.getRectangle(0,2).getFill());
    assertEquals(agent1, thisGridView.getRectangle(1,0).getFill());
    assertEquals(open, thisGridView.getRectangle(1,1).getFill());
    assertEquals(agent1, thisGridView.getRectangle(1,2).getFill());
    assertEquals(agent1, thisGridView.getRectangle(2,0).getFill());
    assertEquals(agent1, thisGridView.getRectangle(2,1).getFill());
