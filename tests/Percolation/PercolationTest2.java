...
public class PercolationTest2 extends DukeTest {
  ...
  public void start(Stage stage) throws IOException {
    thisFileReader = new ReadCSVFile("Examples/Percolation/Test2.csv");
  ...
  public void testFile() throws IOException {
    ...
    int[][] testArray = {{0,2,0},{0,1,1},{0,1,0}};
  ...
  public void testGridData() throws IOException {
    ...
    List<Integer> knownNeighbors = new ArrayList<Integer>(Arrays.asList(0,2,0,0,0,0,1,0));
    ...
    List<Integer> knownNeighbors2 = new ArrayList<Integer>(Arrays.asList(2,0,0,1));
  ...
  public void testGridModel() throws IOException {
    ...
    javafxRun(() -> {
      try {
        test1Percolution.restartSimulationWithNewProp("Percolation2.properties");
      } catch (IOException e) {
        e.printStackTrace();
      }
    });
  ...
  public void testGridView() throws IOException {
    ...
    assertEquals(blocked, thisGridView.getRectangle(0,0).getFill());
