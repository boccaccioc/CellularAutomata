...
public class TreesTest3 extends DukeTest {
  ...
  public void start(Stage stage) throws IOException {
    thisFileReader = new ReadCSVFile("Examples/Trees/Test3.csv");
  ...
  public void testGridModel() throws IOException {
    ...
    javafxRun(() -> {
      try {
        test1TreesController.restartSimulationWithNewProp("Trees3.properties");
      } catch (IOException e) {
        e.printStackTrace();
      }
    });
