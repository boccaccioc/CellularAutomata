...
public class RockPaperScissorsTest3 extends DukeTest {
  ...
  public void start(Stage stage) throws IOException {
    thisFileReader = new ReadCSVFile("Examples/RockPaperScissors/Test3.csv");
  ...
  public void testGridModel() throws IOException {
    ...
    javafxRun(() -> {
      try {
        testRPS.restartSimulationWithNewProp("RockPaperScissors3.properties");
      } catch (IOException e) {
        e.printStackTrace();
      }
    });
  ...
  public void testGridView() throws IOException {
    ...
    assertEquals(paper, thisGridView.getRectangle(0,2).getFill());
    assertEquals(paper, thisGridView.getRectangle(1,0).getFill());
    assertEquals(scissors, thisGridView.getRectangle(1,1).getFill());
    assertEquals(paper, thisGridView.getRectangle(1,2).getFill());
    assertEquals(paper, thisGridView.getRectangle(2,0).getFill());
    assertEquals(paper, thisGridView.getRectangle(2,1).getFill());
    assertEquals(paper, thisGridView.getRectangle(2,2).getFill());
