...
public class RockPaperScissorsTest1 extends DukeTest {
  ...
  public void start(Stage stage) throws IOException {
    thisFileReader = new ReadCSVFile("Examples/RockPaperScissors/Test1.csv");
  ...
  public void testFile() throws IOException {
    ...
    int[][] testArray = {{1,1,1},{1,2,1},{1,1,1}};
  ...
  public void testGridModel() throws IOException {
    ...
    javafxRun(() -> {
      try {
        testRPS.restartSimulationWithNewProp("RockPaperScissors.properties");
      } catch (IOException e) {
        e.printStackTrace();
      }
    });
  ...
  public void testGridView() throws IOException {
    ...
    assertEquals(paper, thisGridView.getRectangle(0,0).getFill());
    assertEquals(paper, thisGridView.getRectangle(0,1).getFill());
